	...
	public final StatContext stat() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(43);
				match(T__4);
				 System.out.println("found expr: " + (((StatContext)_localctx).expr!=null?_input.getText(((StatContext)_localctx).expr.start,((StatContext)_localctx).expr.stop):null)); 
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				...
				setState(49);
				match(T__4);
				 System.out.println("found assign: " + (((StatContext)_localctx).expr!=null?_input.getText(((StatContext)_localctx).expr.start,((StatContext)_localctx).expr.stop):null)); 
				}
				break;
			}
		}
